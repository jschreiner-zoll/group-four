...
- main:
  - button "Patient John Smith, status Critical":
    - text: John Smith Room 201-A Critical 107.5 bpm 125.2 mmHg 79.6 mmHg 98 % 97.2 °F 16 /min 90.3 mg/dL
  ...
  - button "Patient Maria Garcia, status Normal":
    - text: Maria Garcia Room 201-B Normal 92.3 bpm 117.2 mmHg 73.3 mmHg 87.1 % 97.3 °F 15.2 /min 97.6 mg/dL
    - button "Tachycardia"
    - button "Bradycardia"
  ...
  - button "Patient Robert Johnson, status Normal":
    - text: Robert Johnson Room 202-A Normal 77.2 bpm 131.2 mmHg 72.9 mmHg 96.3 % 102.5 °F 17.2 /min 119.4 mg/dL
    - button "Tachycardia"
    - button "Bradycardia"
    - button "Hypoxia"
  ...
  - button "Patient Sarah Williams, status Normal":
    - text: Sarah Williams Room 202-B Normal 92.7 bpm 127.3 mmHg 74.5 mmHg 86.7 % 98 °F 16.4 /min 83.8 mg/dL
    - button "Tachycardia"
    - button "Bradycardia"
    - button "Hypoxia" [disabled]
    - button "Hyperthermia"
  ...
  - button "Patient James Brown, status Critical":
    - text: James Brown Room 203-A Critical 121.2 bpm 106.2 mmHg 62.1 mmHg 99.7 % 98.1 °F 15 /min 119.3 mg/dL
    - button "Tachycardia" [disabled]
    - button "Bradycardia"
    - button "Hypoxia"
    - button "Hyperthermia"
  ...
  - button "Patient Patricia Davis, status Normal":
    - text: Patricia Davis Room 203-B Normal 89.2 bpm 113.9 mmHg 66.1 mmHg 85.5 % 97.3 °F 16.8 /min 82.2 mg/dL
    - button "Tachycardia"
    - button "Bradycardia"
    - button "Hypoxia" [disabled]
    - button "Hyperthermia"
  ...
  - button "Patient Michael Wilson, status Normal":
    - text: Michael Wilson Room 204-A Normal 86.7 bpm 128.2 mmHg 77.6 mmHg 99.9 % 97.8 °F 16.9 /min 85.2 mg/dL
    - button "Tachycardia"
    - button "Bradycardia"
    - button "Hypoxia"
    - button "Hyperthermia"
  ...
  - button "Patient Jennifer Martinez, status Normal":
    - text: Jennifer Martinez Room 204-B Normal 132.9 bpm 118.6 mmHg 68.9 mmHg 99.8 % 97.1 °F 16.6 /min 96.5 mg/dL
    - button "Tachycardia" [disabled]
    - button "Bradycardia"
    - button "Hypoxia"
    - button "Hyperthermia"
  ...
  - button "Patient David Anderson, status Normal":
    - text: David Anderson Room 205-A Normal 89.3 bpm 134.3 mmHg 82.8 mmHg 82.7 % 97.6 °F 13.6 /min 121.7 mg/dL
    - button "Tachycardia"
    - button "Bradycardia"
    - button "Hypoxia" [disabled]
    - button "Hyperthermia"
  ...
  - button "Patient Linda Thomas, status Normal":
    - text: Linda Thomas Room 205-B Normal 65.7 bpm 127.6 mmHg 70.2 mmHg 99.4 % 98.2 °F 17.7 /min 115.2 mg/dL
    - button "Tachycardia"
    - button "Bradycardia"
    - button "Hypoxia"
    - button "Hyperthermia"
