...
- main:
  - button "Patient John Smith, status Critical":
    - text: John Smith Room 201-A Critical 127 bpm 128.3 mmHg 64.2 mmHg 99.1 % 98.5 °F 14.6 /min 85.5 mg/dL
  ...
  - button "Patient Maria Garcia, status Normal":
    - text: Maria Garcia Room 201-B Normal 73.8 bpm 103.9 mmHg 71.7 mmHg 83.3 % 97.5 °F 12.6 /min 99.7 mg/dL
    - button "Tachycardia"
    - button "Bradycardia"
  ...
  - button "Patient Robert Johnson, status Normal":
    - text: Robert Johnson Room 202-A Normal 90.6 bpm 121.1 mmHg 68.4 mmHg 99.5 % 102.3 °F 17.8 /min 98 mg/dL
    - button "Tachycardia"
    - button "Bradycardia"
    - button "Hypoxia"
  ...
  - button "Patient Sarah Williams, status Normal":
    - text: Sarah Williams Room 202-B Normal 76.2 bpm 112.7 mmHg 64.6 mmHg 80.9 % 98.6 °F 15.4 /min 75.3 mg/dL
    - button "Tachycardia"
    - button "Bradycardia"
    - button "Hypoxia" [disabled]
    - button "Hyperthermia"
  ...
  - button "Patient James Brown, status Critical":
    - text: James Brown Room 203-A Critical 118.3 bpm 115.5 mmHg 65.3 mmHg 97.6 % 97.2 °F 17 /min 84.8 mg/dL
    - button "Tachycardia" [disabled]
    - button "Bradycardia"
    - button "Hypoxia"
    - button "Hyperthermia"
  ...
  - button "Patient Patricia Davis, status Normal":
    - text: Patricia Davis Room 203-B Normal 91.4 bpm 128.6 mmHg 65.4 mmHg 85.6 % 97.1 °F 17.7 /min 111 mg/dL
    - button "Tachycardia"
    - button "Bradycardia"
    - button "Hypoxia" [disabled]
    - button "Hyperthermia"
  ...
  - button "Patient Michael Wilson, status Normal":
    - text: Michael Wilson Room 204-A Normal 94.1 bpm 125.2 mmHg 76.4 mmHg 99.3 % 97.8 °F 18.6 /min 105 mg/dL
    - button "Tachycardia"
    - button "Bradycardia"
    - button "Hypoxia"
    - button "Hyperthermia"
  ...
  - button "Patient Jennifer Martinez, status Normal":
    - text: Jennifer Martinez Room 204-B Normal 129.7 bpm 117.5 mmHg 64.1 mmHg 96.9 % 97.4 °F 15.4 /min 95.4 mg/dL
    - button "Tachycardia" [disabled]
    - button "Bradycardia"
    - button "Hypoxia"
    - button "Hyperthermia"
  ...
  - button "Patient David Anderson, status Normal":
    - text: David Anderson Room 205-A Normal 62.6 bpm 133.3 mmHg 69.3 mmHg 80.7 % 97.4 °F 16.7 /min 127.7 mg/dL
    - button "Tachycardia"
    - button "Bradycardia"
    - button "Hypoxia" [disabled]
    - button "Hyperthermia"
  ...
  - button "Patient Linda Thomas, status Normal":
    - text: Linda Thomas Room 205-B Normal 92.7 bpm 118.2 mmHg 76.9 mmHg 95.1 % 98.1 °F 12.4 /min 117.4 mg/dL
    - button "Tachycardia"
    - button "Bradycardia"
    - button "Hypoxia"
    - button "Hyperthermia"
